Rotating Circular CTA Animation
 Overview

This project demonstrates a modern circular text animation used as a call-to-action (CTA). The text rotates smoothly around a central arrow, creating an engaging and interactive UI component.
...
**Features**
Infinite smooth rotation animation
Circular text using SVG path
Center arrow with hover interaction
